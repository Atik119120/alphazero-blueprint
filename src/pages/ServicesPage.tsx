                    ...
                    return (
                      ...
                      >
                        <motion.div
                          ...
                          className="group relative bg-white rounded-[28px] p-7 lg:p-9 shadow-[0_20px_60px_-20px_rgba(34,211,238,0.15),0_10px_30px_-15px_rgba(59,130,246,0.08)] hover:shadow-[0_28px_70px_-20px_rgba(34,211,238,0.22),0_14px_35px_-15px_rgba(59,130,246,0.12)] transition-all border border-black/[0.05] overflow-hidden"
                        >
