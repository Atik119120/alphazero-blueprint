          ...
          {(() => {
            ...
            return (
              ...
              >
                ...
                <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-x-4 gap-y-3 lg:gap-x-6 lg:gap-y-4 items-center justify-items-center">
                  {logos.map((logo, i) => (
