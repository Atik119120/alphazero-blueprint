...
const CoursesNavbar = () => {
  ...
  const contactHref = isLearnSubdomain ? "/contact" : "/learn-contact";
  ...
  const navLinks = [
    ...
    { name: isBn ? "AlphaZero একাডেমি" : "AlphaZero Academy", to: "/courses/all", id: "courses", icon: LayoutGrid, internal: true },
