...
const Footer = () => {
  ...
  return (
    <footer className="relative">
      ...
      <div className="relative h-[34vw] min-h-[150px] max-h-[420px] overflow-hidden bg-background">
        {/* Deep top fade */}
        <div
          className="absolute inset-x-0 top-0 h-[45%] pointer-events-none z-[3]"
          style={{
            background:
        ...
        {/* Wide green wash */}
        <div
          className="absolute inset-x-[-8%] bottom-[-8%] h-[58%] pointer-events-none z-[2]"
          style={{
            background:
        ...
        <div
          className="absolute inset-x-[-10%] bottom-[16%] h-[34%] pointer-events-none z-[4] opacity-80 mix-blend-screen"
          style={{
            background:
        ...
        <div
          aria-hidden="true"
          className="absolute inset-x-0 bottom-[2%] z-[1] text-center leading-[0.72] font-display font-black select-none tracking-tighter pointer-events-none"
          style={{
        ...
        <div
          aria-hidden="true"
          className="absolute inset-x-0 bottom-[17%] z-[3] text-center leading-[0.72] font-display font-black select-none tracking-tighter"
          style={{
            fontSize: "clamp(7rem, 24vw, 24rem)",
            background:
