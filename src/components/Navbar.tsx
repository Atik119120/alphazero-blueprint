      ...
      >
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <motion.div
            ...
            className={`flex items-center justify-between rounded-2xl px-4 sm:px-5 py-2.5 transition-all duration-500 bg-white/10 dark:bg-white/5 backdrop-blur-2xl backdrop-saturate-200 border border-white/30 dark:border-white/10 ${
              isScrolled
